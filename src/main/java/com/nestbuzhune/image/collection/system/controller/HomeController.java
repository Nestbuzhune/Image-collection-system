...
import com.nestbuzhune.image.collection.system.repository.uploadRepository;
...
public class HomeController {
    ...
    public String imageUpload(@RequestParam MultipartFile img, HttpSession session) {
        ...
        Images uploadImg = com.nestbuzhune.image.collection.system.controller.uploadRepository.save(im);
